...
Behold the magnificence of this Flask App, seamlessly integrating with the
AirBnB static HTML Template.

Witness the elegance of our code as it orchestrates a symphony of states,
cities, and amenities.

Marvel at the wonders of Flask as it gracefully renders the 2-hbnb.html
...
Let your imagination soar as we embark on this journey of creativity and
innovation!
...
@app.route('/2-hbnb')  # Updated route to /2-hbnb
def hbnb_filters(the_id=None):
    ...
    cache_id = uuid4()
    return render_template('2-hbnb.html',  #Updated templt name to 2-hbnb.html
                           states=states,
                           amens=amens,
                           places=places,
                           users=users,
