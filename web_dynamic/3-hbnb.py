...
Marvel at the wonders of Flask as it gracefully renders the 3-hbnb.html
...
@app.route('/3-hbnb')  # Updated route to /3-hbnb
def hbnb_filters(the_id=None):
    ...
    cache_id = uuid4()
    return render_template('3-hbnb.html',  # Updated templt name to 3-hbnb.html
                           states=states,
                           amens=amens,
                           places=places,
                           users=users,
